...
class CloudTests(unittest.TestCase):
 ...
 def app(self,send_email=lambda *a:(_ for _ in ()).throw(AssertionError('send called')),send_draft=lambda *a:(_ for _ in ()).throw(AssertionError('send draft called')),approve_draft=lambda *a:{'status':'approved'}):
  app=FastAPI(); drafts={}
